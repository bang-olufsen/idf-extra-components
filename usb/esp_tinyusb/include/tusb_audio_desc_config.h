...
#define TINYUSB_AUDIO_DESC_LEN TUD_AUDIO_MIC_FOUR_CH_DESC_LEN
#elif CONFIG_TINYUSB_AUDIO_CHANNELS == 2
#define TINYUSB_AUDIO_DESC_LEN TUD_AUDIO_MIC_TWO_CH_DESC_LEN
#else
#define TINYUSB_AUDIO_DESC_LEN TUD_AUDIO_MIC_ONE_CH_DESC_LEN
#endif

#define TINYUSB_AUDIO_SAMPLE_RATE CONFIG_TINYUSB_AUDIO_SAMPLE_RATE
